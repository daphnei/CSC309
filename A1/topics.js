...
var topics = {
    ...
    */
    show_form: function () {
        ...
        var form = '<form name="about_to_submit">' + 
    ...
    */
    createHTML: function(topic_id, title, interest_link, vote_count, comment_count){
        ...
        var html_topic = '<li id=' +  topic_id + ' class="topic">' +
    ...
    */
    bind_comment: function(topic_id){
        ...
        $('#' + topic_id).find('ul.counts').find('li.show_comments').click(function(){
            ...
            // Binds the comment button on the topics
    ...
    * @return {Boolean} False if form value is invalid, true otherwise
    */
    submit: function() {
